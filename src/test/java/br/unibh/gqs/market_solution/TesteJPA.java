...
public class TesteJPA {
  ...
  public void test06() {
      ...
      BigDecimal totalComDescontoEsperado = i.getProduto().getPreco().multiply(new BigDecimal(i.getQuantidade()))
              .add(i2.getProduto().getPreco().multiply(new BigDecimal(i2.getQuantidade())));
